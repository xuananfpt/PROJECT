                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" name="fullname" id="display-name" value="<?php echo $info_user['fullname'] ?>">
                                <p class="error">
                                ...
                                <textarea  class="w-100 form-control" height="80px" name="address" id="address"><?php echo $info_user['address'] ?></textarea>
                                <p class="error">
