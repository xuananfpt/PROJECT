        ...
        <div class="main-content fl-right">
            <div class="section" id="detail-blog-wp">
                <div class="section-head clearfix">
                    <h3 class="section-title"><?= $get_post[0]['post_title'] ?></h3>
                </div>
                <div class="section-detail">
                    <span class="create-date"><?= $get_post[0]['create_time'] ?></span>
                    <div class="detail">
                        <p><strong><?= $get_post[0]['short_content'] ?></strong></p>
                        <p></p>
                        <div style="text-align: center;">
                            <img src="admin/public/images/<?= $get_post[0]['post_image'] ?>" alt="">
                        </div>
                        <p><?= $get_post[0]['post_content'] ?></p>
                    </div>
                </div>
            </div>
