            ...
            <div class="section" id="list-blog-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item">
                        ...
                        ?>
                            <li class="clearfix">
                                <a href="?mod=post&action=detailPost&id=<?= $post['post_id'] ?>" title="" class="thumb fl-left">
                                    <img src="admin/public/images/<?= $post['post_image'] ?>" alt="">
                                </a>
                                <div class="info fl-right">
                                    <a href="?mod=post&action=detailPost&id=<?= $post['post_id'] ?>" title="" class="title"><?= $post['post_title'] ?></a>
                                    <span class="post_creator">Tạo bởi: <?= $post['post_creator'] ?></span>
                                    <span class="create-date"><?= $post['create_time'] ?></span>
                                    <p class="desc"><?= $post['short_content'] ?></p>
                                </div>
                            </li>
                        <?php } ?>
                        <!-- <li class="clearfix">
