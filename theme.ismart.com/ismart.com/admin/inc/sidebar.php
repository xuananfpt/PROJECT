<div id="sidebar" class="fl-left">
    <ul id="sidebar-menu">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="?page=list_user" title="" class="nav-link">Danh sách tài khoản</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="?page=add_cat" title="" class="nav-link">Thêm mới danh mục</a>
                </li>
                <li class="nav-item">
                    <a href="?page=list_cat" title="" class="nav-link">Danh mục</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?page=list_post" title="" class="nav-link">Danh sách khách hàng</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
