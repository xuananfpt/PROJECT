...
{
    $list_profit = db_fetch_array("SELECT tbl_category.cat_id, tbl_category.cat_name, SUM(tbl_detail_dh.quantity) AS soluongdonhang, SUM(tbl_detail_dh.quantity*tbl_detail_dh.unit_price) as tongtien FROM
