        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?mod=product&action=addProduct" title="" id="add-new" class="fl-left btn btn-danger">Thêm
                        mới</a>
                                    ...
                                    foreach ($list_product_by_cat as $item) {
                                        ...
                                        <td>
                                            ...
                                            <ul class="list-operation fl-right ">
                                                <li><a href="?mod=product&action=editProduct&id=<?= $item['product_id'] ?>"
                                                        title="Sửa" class="edit"><i class="fa fa-pencil"
                                                            aria-hidden="true"></i></a></li>
                                                <li><a href="?mod=product&action=delProductsoft&id=<?= $item['product_id'] ?>"
                                        ...
                                        <td>
                                            <span class="tbody-thumb  text-center">
                                                ...
                                                <img class="" width="150px" height="auto"
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    <ul class="post-status fl-left mt-2">
                        ...
                        <li class="pending btn bg-danger"><a class="text-white" href="?mod=product&action=trashProduct">Thùng rác<span
                                    class="count text-white"></span></a></li>
                    </ul>
                    </p>
