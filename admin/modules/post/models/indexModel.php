...
function get_list_post_trash()
{
    $list_post = db_fetch_array("SELECT * FROM `tbl_post` where `post_status`='Không hoạt động'");
    return $list_post;
}
...
function delPostsoft($id, $update)
{
    db_update("tbl_post", $update, "post_id='$id'");
}
function resPost($id, $update)
{
    db_update("tbl_post", $update, "post_id='$id'");
}
